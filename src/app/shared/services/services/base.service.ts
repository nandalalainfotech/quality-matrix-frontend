...
import { User001mb } from '../restcontroller/entities/User001mb';
...
export class BaseService {
    ...
    ngOnInit() {
        ...
        this.currentUser =
            userJson !== null ? JSON.parse(userJson) : new User001mb();
    ...
    private handleError(error: Response | any, url: string) {
        ...
        if (
            ...
            this.calloutService.showError('Invalid Request',error.error?.message);
            return throwError(error);
        }
    }
    // starting pointing
